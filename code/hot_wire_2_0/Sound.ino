...
note_t melody_1[] = { 
  {NOTE_C4,16},{NOTE_PAUSE,16},
  {NOTE_E4,16},{NOTE_PAUSE,16},{NOTE_G4,16}
};

note_t melody_2[] = { 
  {NOTE_C5,16},{NOTE_PAUSE,16},{NOTE_G4,16},{NOTE_G4,16},
  {NOTE_A4,16},{NOTE_PAUSE,16},{NOTE_B4,16},{NOTE_PAUSE,16},{NOTE_C5,16}
};
...
void sound_start_GameStartMelody()
{
  ...
  #ifdef TRACE_SOUND
         Serial.print(F(">TRACE_SOUND sound_active_melody_length=")); Serial.println(sound_active_melody_length);
  #endif 
}
...
void sound_start_beep()
{
  sound_current_effect=sound_beep;
  sound_current_note=0;
  sound_wait_millis=1;
  tone(SOUND_OUT_PIN, 440+abs((foul_counter+foul_current_cumulation)/150));
}
...
void sound_play_crash(){
  tone(SOUND_OUT_PIN, random(50,800));
  sound_wait_millis=1;
  if(++sound_current_note>1250) sound_stop();
